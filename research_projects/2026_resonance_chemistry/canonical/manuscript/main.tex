...
systems exhibit a deficit of very closely spaced pairs, concentrations and
asymmetries near some low-order commensurabilities, and correlated planet sizes
within individual systems \citep{fabrycky2014,weiss2018,millholland2021}.
Their separations also cluster at roughly 12--20 mutual Hill radii
\citep{fang_margot_2013,puwu2015}. Planetary architectures are therefore
structured, but the presence of structure does not imply that every pair near
an integer ratio is dynamically resonant.
...
per-system results, and figure-generation code are included with the
submission and will be archived as a new version at Zenodo before publication.
The canonical analysis uses seed 20260711 and 2000 draws per feasible system.
The corrected deposit will supersede the rejection-sampling outputs in version
4.0 (doi:10.5281/zenodo.21230853).
